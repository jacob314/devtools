...
final TextStyle link = TextStyle(color: Colors.blue.shade700, decoration: TextDecoration.underline);

const TextStyle regularBold =  TextStyle(color: Colors.black, fontWeight: FontWeight.w700);
const TextStyle regularItalic =  TextStyle(color: Colors.black, fontStyle: FontStyle.italic);
