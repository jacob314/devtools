...
PButton createExtensionButton(ServiceExtensionDescription extensionDescription) {
  final PButton button = new PButton.icon(extensionDescription.description, extensionDescription.icon, title: extensionDescription.tooltip)..small();
...
CoreElement createExtensionCheckBox(ServiceExtensionDescription extensionDescription) {
  final extensionName = extensionDescription.extension;
